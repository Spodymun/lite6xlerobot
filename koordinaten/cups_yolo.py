#!/usr/bin/env python3
"""
Cup Detection via YOLO - Simplified version

Machine-readable output:
  CUP_MM x_mm y_mm conf

Beispiel:
  python3 cups_yolo.py --cam 0 --H H.npy --device cpu --once
"""
...
def main():
    ap = argparse.ArgumentParser(description="Cup detection via YOLO - Simplified version")
